...
namespace CreatorKitCodeInternal {
        ...
        AnimationControllerDispatcher.IFootstepFrameReceiver
    {
        ...
        void Start()
        {
            ...
            if (photonView.IsMine)
            {
                CameraController _cameraWork = FindObjectOfType<CameraController>();
                var camera = _cameraWork.GetComponent<CinemachineVirtualCamera>();
                camera.Follow = transform;

                Data.Stats.CurrentHealth = PlayfabUserData.PlayFabHealth;
            }
