...
namespace CreatorKitCodeInternal 
{
    ...
    public class UISystem : MonoBehaviour
    {
        ...
        void UpdatePlayerUI()
        {
            CharacterData data = CharacterControl.Instance.Data;
        
            PlayerHealthSlider.value = CharacterControl.Instance.Data.Stats.CurrentHealth / (float)CharacterControl.Instance.Data.Stats.stats.health;
            MaxHealth.text = CharacterControl.Instance.Data.Stats.stats.health.ToString();
            CurrentHealth.text = CharacterControl.Instance.Data.Stats.CurrentHealth.ToString();
        
            if (CharacterControl.Instance.CurrentTarget != null)
            {
                UpdateEnemyUI(CharacterControl.Instance.CurrentTarget);
            }
            else
            {
        ...
        public void ToggleInventory()
        {
            ...
            else
            {
                ...
                InventoryWindow.Load(CharacterControl.Instance.Data);
